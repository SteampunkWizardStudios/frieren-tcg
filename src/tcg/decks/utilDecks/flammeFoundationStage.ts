...
export const a_foundationOfHumanitysMagicBase = new Card({
  ...
  description: ([stat]) => `ATK+${stat} SPD+${stat}. Deal ${stat} DMG.`,
...
export const a_firstPageOfHumanitysMagicBase = new Card({
  ...
  cardMetadata: { nature: Nature.Attack },
  description: ([stat, dmg]) => `ATK+${stat} SPD+${stat}. DMG ${dmg}.`,
  emoji: CardEmoji.FLAMME_CARD,
  effects: [1, 8],
  hpCost: 4,
  cardAction: function (
...
export const a_secondPageOfHumanitysMagicBase = new Card({
  ...
  cardMetadata: { nature: Nature.Attack },
  description: ([stat]) =>
    `ATK+${stat} SPD+${stat}. Use a random rare offensive magic.`,
  emoji: CardEmoji.FLAMME_CARD,
  effects: [2],
...
export const a_thirdPageOfHumanitysMagicBase = new Card({
  ...
  cardMetadata: { nature: Nature.Attack },
  description: ([stat, dmg]) => `ATK+${stat} SPD+${stat}. Deal ${dmg} DMG.`,
  emoji: CardEmoji.FLAMME_CARD,
  effects: [2, 17],
  hpCost: 10,
  cardAction: function (
...
export const a_lastPageOfHumanitysMagicBase = new Card({
  ...
  cardMetadata: { nature: Nature.Attack },
  description: ([stat]) =>
    `ATK+${stat} SPD+${stat}. Use a random unusual offensive magic.`,
  emoji: CardEmoji.FLAMME_CARD,
  effects: [3],
  cardAction: function (this: Card, context: GameMessageContext) {
    const { selfStat } = context;
